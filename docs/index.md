...
*This project is [open source]({{ '/LICENSE' | relative_url }}) and maintained by the xDevOps community.*
sacha@sacha-VMware-Virtual-Platform:~/Downloads/devops-sre-ai-atlas-2025-updated/devops-sre-ai-atlas-2025/docs$ ls
archetypes.md    community.md  index.md              platforms
capabilities.md  _config.yml   platform-overview.md
sacha@sacha-VMware-Virtual-Platform:~/Downloads/devops-sre-ai-atlas-2025-updated/devops-sre-ai-atlas-2025/docs$ cat index.md 
---
layout: default
title: Home
nav_order: 1
